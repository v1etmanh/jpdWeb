...
public class VNPayController {
    ...
    public ResponseEntity<?> createOrder(
            ...
            @Email @NotBlank @RequestParam("customerEmail") String customerEmail) {

        try {
            log.info("Creating VNPay order: courseId={}, amount={}, customerEmail={}", courseId, amount, customerEmail);
