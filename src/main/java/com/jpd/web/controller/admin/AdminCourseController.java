...
public class AdminCourseController {
    ...
    @GetMapping("/{courseId}")
    public ResponseEntity<ApiResponse<AdminCourseDto>> getCourseById(@PathVariable Long courseId) {
        AdminCourseDto course = adminCourseService.getCourseById(courseId);
    ...
    @PostMapping("/{courseId}/toggle-public")
    public ResponseEntity<ApiResponse<String>> toggleCoursePublicStatus(@PathVariable Long courseId) {
        adminCourseService.toggleCoursePublicStatus(courseId);
        return ResponseEntity.ok(ApiResponse.success("Course public status toggled successfully"));
    }
}
