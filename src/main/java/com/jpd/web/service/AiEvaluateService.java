...
public SemanticResult evaluateSpeaking(MultipartFile audio ,  String expectedAnswer,String language) throws Exception
...
private void validateInputs(MultipartFile audio, String expectedAnswer, 
        String language) throws AIHandlerException {
