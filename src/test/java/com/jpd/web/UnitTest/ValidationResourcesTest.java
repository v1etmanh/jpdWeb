...
class ValidationResourcesTest {
    ...
    @BeforeEach
    void setUp() {
        // Setup mock Creator using builder
        mockCreator = Creator.builder()
                .creatorId(1L)
                .build();

        // Setup mock Course using builder
        mockCourse = Course.builder()
                .courseId(1L)
                .creator(mockCreator)
                .build();

        // Setup mock Chapter using builder
        mockChapter = Chapter.builder()
                .chapterId(1L)
                .course(mockCourse)
                .build();

        // Setup mock Module using builder
        mockModule = com.jpd.web.model.Module.builder()
                .moduleId(1L)
                .chapter(mockChapter)
                .build();

        // Setup mock Customer using builder
        mockCustomer = Customer.builder()
                .customerId(1L)
                .email("test@test.com")
                .build();

        // Setup mock Enrollment using builder
    ...
    class ValidateCourseOwnershipTestsFromCSV {
        ...
        private void executeCourseOwnershipTest(Map<String, String> data) {
            ...
            // Setup test entities using builder
            Creator testCreator = Creator.builder()
                    .creatorId(creatorId)
                    .build();

            Creator courseOwner = Creator.builder()
    ...
    class ValidateChapterBelongsToCourseTestsFromCSV {
        ...
        private void executeChapterValidationTest(Map<String, String> data) {
            ...
            Chapter testChapter = Chapter.builder()
                    .chapterId(chapterId)
                    .course(testCourse)
                    .build();
    ...
    class ValidateModuleBelongsToChapterTestsFromCSV {
        ...
        private void executeModuleValidationTest(Map<String, String> data) {
            ...
            // Setup test entities using builder
            Chapter testChapter = Chapter.builder()
                    .chapterId(moduleChapterId)
                    .build();

            com.jpd.web.model.Module testModule = com.jpd.web.model.Module.builder()
                    .moduleId(moduleId)
                    .chapter(testChapter)
                    .build();
    ...
    class ValidateCustomerWithCourseTestsFromCSV {
        ...
        private void executeCustomerCourseAccessTest(Map<String, String> data) {
            ...
            // Setup test entities using builder
            Customer testCustomer = Customer.builder()
                    .customerId(isCreator ? 1L : 2L)
                    .email(customerEmail)
                    .build();

            Customer creatorCustomer = Customer.builder()
                    .customerId(1L)
