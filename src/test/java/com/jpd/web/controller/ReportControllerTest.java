...
class ReportControllerTest {
    ...
    @Test
    void createNewReport_HappyPath_200() throws Exception {
    ...
    void createNewReport_VietnameseUTF8Body_OK() throws Exception {
        ...
        mockMvc.perform(post(URL)
                ...
                .content(json)
                .with(jwt().jwt(jwt -> jwt.claim("email", email))))
            .andExpect(status().isOk()); // Was .isNoContent(), but actual is 200 OK
    ...
    @Test
    void createNewReport_MissingRequiredField_200Ok() throws Exception {
        // thiếu type
     ...
     */
    @Test
    void createNewReport_BlankDetail_200Ok() throws Exception {
    ...
    @Test
    void createNewReport_RequireScope_NoScope_Expect200() throws Exception {
        // Vì hiện tại endpoint không thực sự kiểm tra scope nên API trả về 200 OK thay vì 204 hoặc 403
        mockMvc.perform(post(URL)
                .contentType(MediaType.APPLICATION_JSON)
                .content(validBody())
